...
SEARCH_PAUSE_SECONDS = float(os.environ.get("YOLO_SEARCH_PAUSE_SECONDS", "0.25"))
TRACK_TURN_SECONDS = float(os.environ.get("YOLO_TRACK_TURN_SECONDS", "0.12"))
...
CENTER_TOLERANCE_Y_RATIO = float(
    os.environ.get("YOLO_CENTER_TOLERANCE_Y_RATIO", "0.16")
)
